    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPhotos", x => new { x.ProductId, x.Photo });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductItem_ItemType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProductItem_Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProductItem_Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    ProductItem_Photos = table.Column<string>(type: "NVARCHAR(MAX)", nullable: true),
